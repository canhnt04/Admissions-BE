...
namespace Driving.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260731103233_AddMassTransitOutbox")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Driving.Domain.Entities.AssignmentQueue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Driving.Domain.Entities.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Driving.Domain.Entities.ContactEvidence", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Driving.Domain.Entities.Course", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Driving.Domain.Entities.CourseParticipant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Driving.Domain.Entities.CourseParticipantPayment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Driving.Domain.Entities.CustomTag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Driving.Domain.Entities.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Driving.Domain.Entities.CustomerAssignmentHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Driving.Domain.Entities.CustomerCareStatus", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Driving.Domain.Entities.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Driving.Domain.Entities.SlaTracking", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Driving.Domain.Entities.UserReplica", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Driving.Domain.Entities.ContactEvidence", b =>
                {
                    b.HasOne("Driving.Domain.Entities.Customer", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("Driving.Domain.Entities.Course", b =>
                {
                    b.HasOne("Driving.Domain.Entities.CustomTag", "CustomTag")
                        .WithMany()
            ...
            modelBuilder.Entity("Driving.Domain.Entities.CourseParticipant", b =>
                {
                    b.HasOne("Driving.Domain.Entities.Course", "Course")
                        .WithMany()
            ...
            modelBuilder.Entity("Driving.Domain.Entities.CourseParticipantPayment", b =>
                {
                    b.HasOne("Driving.Domain.Entities.CourseParticipant", "CourseParticipant")
                        .WithMany()
            ...
            modelBuilder.Entity("Driving.Domain.Entities.Customer", b =>
                {
                    b.HasOne("Driving.Domain.Entities.UserReplica", "AssigneeUser")
                        .WithMany()
